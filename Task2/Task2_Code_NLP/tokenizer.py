...
# Below part is modified for Task 2 
import spacy, nltk
...
# return POS tags, dependency relations, WordNet synset counts 
def get_linguistic_features(text: str):
    """Extract POS tags, dependency relations and WordNet synset counts"""
    doc = nlp(text)
    features = []
    for token in doc:
...
class BertTokenizer(PreTrainedTokenizer):
  ...
  # Below part is added for Task 2:
  def extract_linguistic_features(self, text: str):
    """ Extract POS tags, dependency relations, and WordNet synsets from text.    
        Args: text: Input text string
        Returns: List of dictionaries with linguistic features for each token """
    return get_linguistic_features(text) 
